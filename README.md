...
[code](https://drive.google.com/file/d/108GugB5e8sS_BZuOAMgFwMsDRQvkD0qE/view?usp=sharing)
...
That is, a smaller CD value indicates a higher fidelity. In the following, the point clouds are normalized into a unit sphere (i.e. [-1,1]).
* Ours. <br>
CD: 0.003029<br>
